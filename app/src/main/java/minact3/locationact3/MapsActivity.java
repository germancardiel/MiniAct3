...
public class MapsActivity extends AppCompatActivity
    ...
    public void onMapReady(GoogleMap map) {
        mMap = map;//provee de una instancia del objeto googlemap para manipularlo cuando este cargado
    ...
    protected void onResumeFragments() {
        super.onResumeFragments();// la localizacion propia se desactiva
...
//llama a metodos del objeto googlemaps
